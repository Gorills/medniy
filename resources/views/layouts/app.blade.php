...
<head>
    ...
    <meta name="keywords" content=">Апрель 2019 - этапы строительства нового жилого комплекса Медный 3.14 на ул. Донской, 14. Отдел продаж: +7 (495) 023-78-37" />
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li><a class="nav-link" href="{{ route('home') }}">На сайт</a></li>
                        @else
